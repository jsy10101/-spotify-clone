...
// using static keyword we don't need to create an instance of class everytime
// we can just access the color using Pallete.greenColor instead of Pallete().greenColor
class Pallete {
